...
## 2. 鼠标移动到三维视图中，然后鼠标移动到四个封闭的多边形，并用鼠标双击它
...
## 5. 鼠标移动到这个不规则形状的侧面，找到一个显示的水平边缘线，同时按下键盘上的Tab键多次
...
## 6. 鼠标左击出现顶部的水平的封闭的多边形，在功能区鼠标左击“编辑轮廓”
...
## 7. 鼠标双击“楼层平面”的“f3-展厅”视图，在打开的平面视图中，随意修改紫色的多边形形状，然后鼠标左击功能区上的完成键
...
## 8. 鼠标左击三维视图，在打开的三维视图中，鼠标移动到这个不规则形状的顶面的边缘线，同时按下键盘上的Tab键多次
...
## 10. 鼠标在三维视图中随意修改紫色的多边形形状的线条，然后鼠标左击功能区上的完成键
